...
(possible row 1 column 1 value 2 group 1 id 1)
...
(possible row 3 column 2 value 7 group 1 id 8)
...
(possible row 2 column 5 value 3 group 2 id 14)
(possible row 2 column 6 value any group 2 id 15)
(possible row 3 column 4 value any group 2 id 16)
(possible row 3 column 5 value 9 group 2 id 17)
(possible row 3 column 6 value 4 group 2 id 18)

(possible row 1 column 7 value any group 3 id 19)
(possible row 1 column 8 value 3 group 3 id 20)
(possible row 1 column 9 value any group 3 id 21)
(possible row 2 column 7 value 7 group 3 id 22)
...
(possible row 4 column 1 value 1 group 4 id 28)
...
(possible row 5 column 3 value 5 group 4 id 33)
(possible row 6 column 1 value 8 group 4 id 34)
(possible row 6 column 2 value 2 group 4 id 35)
...
(possible row 4 column 6 value 7 group 5 id 39)
...
(possible row 6 column 4 value 3 group 5 id 43)
...
(possible row 4 column 8 value 8 group 6 id 47)
(possible row 4 column 9 value 6 group 6 id 48)
(possible row 5 column 7 value 9 group 6 id 49)
...
(possible row 9 column 9 value 5 group 9 id 81)
