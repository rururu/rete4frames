...
(possible row 1 column 3 value 6 group 1 id 3)
...
(possible row 1 column 5 value 7 group 2 id 11)
(possible row 1 column 6 value any group 2 id 12)
(possible row 2 column 4 value 2 group 2 id 13)
(possible row 2 column 5 value any group 2 id 14)
(possible row 2 column 6 value 3 group 2 id 15)
(possible row 3 column 4 value any group 2 id 16)
(possible row 3 column 5 value 4 group 2 id 17)
...
(possible row 4 column 6 value 2 group 5 id 39)
...
(possible row 6 column 4 value 4 group 5 id 43)
...
(possible row 6 column 9 value 3 group 6 id 54)

(possible row 7 column 1 value any group 7 id 55)
(possible row 7 column 2 value 4 group 7 id 56)
...
(possible row 8 column 4 value 3 group 8 id 67)
(possible row 8 column 5 value any group 8 id 68)
(possible row 8 column 6 value 6 group 8 id 69)
(possible row 9 column 4 value any group 8 id 70)
(possible row 9 column 5 value 2 group 8 id 71)
(possible row 9 column 6 value 4 group 8 id 72)
...
(possible row 9 column 7 value 7 group 9 id 79)
