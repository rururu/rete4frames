...
(possible row 3 column 1 value 3   group 1 id 7)
(possible row 3 column 2 value 1   group 1 id 8)
(possible row 3 column 3 value any group 1 id 9)

(possible row 1 column 4 value 3   group 2 id 10)
...
(possible row 3 column 4 value 7   group 2 id 16)
(possible row 3 column 5 value any group 2 id 17)
(possible row 3 column 6 value 9   group 2 id 18)

(possible row 1 column 7 value any group 3 id 19)
(possible row 1 column 8 value any group 3 id 20)
(possible row 1 column 9 value 6   group 3 id 21)
(possible row 2 column 7 value 9   group 3 id 22)
(possible row 2 column 8 value 1   group 3 id 23)
(possible row 2 column 9 value any group 3 id 24)
(possible row 3 column 7 value any group 3 id 25)
(possible row 3 column 8 value 2   group 3 id 26)
(possible row 3 column 9 value any group 3 id 27)

(possible row 4 column 1 value 6   group 4 id 28)
(possible row 4 column 2 value 2   group 4 id 29)
(possible row 4 column 3 value 7   group 4 id 30)
...
(possible row 6 column 7 value 2   group 6 id 52)
(possible row 6 column 8 value 7   group 6 id 53)
(possible row 6 column 9 value 4   group 6 id 54)

(possible row 7 column 1 value any group 7 id 55)
(possible row 7 column 2 value 6   group 7 id 56)
(possible row 7 column 3 value any group 7 id 57)
(possible row 8 column 1 value any group 7 id 58)
(possible row 8 column 2 value 4   group 7 id 59)
(possible row 8 column 3 value 5   group 7 id 60)
(possible row 9 column 1 value 9   group 7 id 61)
...
(possible row 7 column 6 value 1   group 8 id 66)
