...
public class ReteTest {
	...
	public static void main(String[] args){
        ...
        System.out.println("\n MONKEY AND BANANAS \n");
		rete.core.reteApp("run:asynch", "../examples/mab.clj");
        System.out.println("\n ZEBRA \n");
		rete.core.reteApp("run:synch", "../examples/zebra.clj");
        System.out.println("\n Mrs. MANNERS \n");
		rete.core.reteApp("run:asynch", "../examples/manners.clj");
        System.out.println("\n WALTZ \n");
		rete.core.reteApp("run:asynch", "../examples/waltz.clj");
        System.out.println("\n MONKEY AND BANANAS 2 \n");
        // First run MAB with empty fact list
		rete.core.reteAppFacts("run:asynch", "../examples/mab.clj", "../examples/zero_facts.clj");
		...
		rete.core.assertFact("monkey", slots);
		...
		rete.core.assertFact("thing", slots);
		...
		rete.core.assertFact("chest", slots);
		...
		rete.core.assertFact("goal-is-to", slots);
		System.out.println("\n FIRE 9 RULES \n");
		rete.core.fire(9);
		System.out.println("\n FIRE 4 RULES \n");
		rete.core.fire(4);
		...
		HashMap afacts = rete.core.allFacts();
        ...
        System.out.println("\n CHEST FINAL FACTS \n");
		Collection chests = rete.core.factsOfType("chest");
